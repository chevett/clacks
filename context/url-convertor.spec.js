 ...
 describe('url-convertor', function(){
	...
	describe('#createToProxyUrlFn(...)(...)', function(){
		...
		it('should convert relative urls when there is a request context', function(){
			...
			var toProxyUrlFn = require('./url-convertor').createToProxyUrlFn(testHelper.createRequest('github.com'));
		...
		it('should create secure absolute urls from relative urls when the parent request is secure', function(){
			var url = '/chevett/miketown3';
			var toProxyUrlFn = require('./url-convertor').createToProxyUrlFn(testHelper.createSecureRequest('https://github.com'));
		...
		it('should preserve the protocol override from the context when creating relative urls', function(){
			var url = '/chevett/miketown3';
			var toProxyUrlFn = require('./url-convertor').createToProxyUrlFn(testHelper.createSecureRequest('http://github.com'));
		...
		it('should convert really relative urls when there is a request context', function(){
			var url = 'miketown3';
			var toProxyUrlFn = require('./url-convertor').createToProxyUrlFn(testHelper.createRequest('github.com/chevett/'));
	...
	describe('#createFromProxyUrlFn(...)(...)', function(){
		it('should convert valid url', function(){
			...
			var fromProxyUrlFn = require('./url-convertor').createFromProxyUrlFn(testHelper.createRequest('github.com'));
		...
		it('should default to https for a secure connection with no protocol', function(){
			var url = 'github.com/chevett/miketown3';
			var fromProxyUrlFn = require('./url-convertor').createFromProxyUrlFn(testHelper.createSecureRequest('github.com'));
		...
		it('should use protocol in the url regardless of the context', function(){
			...
			var fromProxyUrlFn = require('./url-convertor').createFromProxyUrlFn(testHelper.createSecureRequest('http://github.com'));
