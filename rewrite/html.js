...
module.exports = function(html, urlRewriter) {
    ...
    if (settings.showNavBar) {
        ...
        $('body').prepend(
            '<div class="mt3_navbar" style="position: relative;z-index: 99999;top: -42px;*position: relative;*z-index: 2;margin-bottom: 20px;overflow: visible;"> \
                <div class="mt3_navbar-inner" style="min-height: 40px;padding-right: 20px;padding-left: 20px;background-color: #fafafa;background-image: linear-gradient(to bottom, #ffffff, #f2f2f2);background-repeat: repeat-x;border: 1px solid #d4d4d4;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=&quot;#ffffffff&quot;, endColorstr=&quot;#fff2f2f2&quot;, GradientType=0);*zoom: 1;-webkit-box-shadow: 0 1px 4px rgba(0, 0, 0, 0.065);-moz-box-shadow: 0 1px 4px rgba(0, 0, 0, 0.065);box-shadow: 0 1px 4px rgba(0, 0, 0, 0.065);"> \
